 ...
 */
final class Version20200415102600 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE author_id author_id INT DEFAULT NULL, CHANGE likes likes INT DEFAULT NULL, CHANGE published_at published_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE tags CHANGE times_used times_used INT DEFAULT NULL');
    }
}
